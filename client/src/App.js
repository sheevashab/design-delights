  ...
  return (
    <div className="bg-red-50">
      ...
      <Route exact path="/">
        ...
        <p className="mt-8 text-center text-xl text-gray-700 font-semibold">Welcome to Design Delights!</p>
        <p className="mt-4 ml-8 mr-8 text-center text-l text-gray-700 font-light leading-relaxed">This is an interactive blog where you, the user, can stop by to gain a little inspo or to give a little inspo. </p>
